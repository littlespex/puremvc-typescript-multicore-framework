...
import { INotifyMethod } from '../../interfaces/INotifyMethod';
...
export class Observer implements IObserver {
	 ...
	 */
	private notify: INotifyMethod = null;
	 ...
	 * 		The notification context of the interested object.
	 */
	constructor(notifyMethod: INotifyMethod, notifyContext: any) {
	 ...
	 */
	private getNotifyMethod(): INotifyMethod {
		return this.notify;
	}
	 ...
	 * 		The notification (callback) method of the interested object.
	 */
	setNotifyMethod(notifyMethod: INotifyMethod): void {
