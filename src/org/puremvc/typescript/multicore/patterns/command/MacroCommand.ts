...
export class MacroCommand
	 ...
	 */
	protected subCommands: ICommandClass[] = null;
	...
	constructor() {
		...
		this.subCommands = new Array<ICommandClass>();
	 ...
	 */
	protected addSubCommand(commandClassRef: ICommandClass): void {
	...
	execute(notification: INotification): void {
		const subCommands: ICommandClass[] = this.subCommands.slice(0);
		...
		for (let i = 0; i < len; i++) {
			 ...
			 */
			const commandClassRef: ICommandClass = subCommands[i];
