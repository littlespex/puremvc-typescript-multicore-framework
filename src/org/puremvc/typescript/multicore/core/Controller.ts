...
import { ICommandClass } from '../interfaces/ICommandClass';
 ...
 * @constant
 */
export const MULTITON_MSG = 'Controller instance for this multiton key already constructed!';
...
export class Controller implements IController {
	 ...
	 */
	protected commandMap: Record<string, ICommandClass> = null;
	 ...
	 */
	registerCommand(notificationName: string, commandClassRef: ICommandClass): void {
	 ...
	 * 
	 * @param notificationName
	 * 		Name of the <code>Notification</code> to check whether an <code>ICommand</code> is
	 * 		registered for.
	 *
	 * @return
	 ...
	 */
	protected static instanceMap: Record<string, IController> = {};
